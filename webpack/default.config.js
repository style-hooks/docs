...
module.exports = merge(
  {
    ...
    resolve: {
      modules: [paths.modules],
      alias: {
        ...createAliases(paths.inherits),
        'core-js': path.resolve(__dirname, '../node_modules/core-js'),
        react: path.resolve(__dirname, '../node_modules/react'),
        'react-dom': path.resolve(__dirname, '../node_modules/react-dom'),
        'curls': path.resolve(__dirname, '../node_modules/curls'),
        '@style-hooks': path.resolve(__dirname, '../node_modules/@style-hooks'),
        '@babel': path.resolve(__dirname, '../node_modules/@babel'),
        '@render-props': path.resolve(__dirname, '../node_modules/@render-props'),
        '@react-hook': path.resolve(__dirname, '../node_modules/@react-hook'),
